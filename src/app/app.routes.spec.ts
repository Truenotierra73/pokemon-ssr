...
describe('App Routes', () => {
  ...
  it('should navigate to "unkownn-page" redirects to "/about"', async () => {
  ...
  it('should load the proper component', async () => {
    const aboutRoute: Route = routes.find((route) => route.path === 'about')!;
    ...
    const pokemonsPageRoute: Route = routes.find(
